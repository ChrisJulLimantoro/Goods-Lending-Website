    ...
    <div class="container-fluid detail-box">
        ...
        <div class="row mt-5 px-3 py-4 bg-dark text-light">
            <div class="col-lg-3 col-5">
                <img src="https://img2.pngdownload.id/20180611/web/kisspng-cardboard-box-computer-icons-5b1e549bbe6db0.87161963152871439578.jpg" id="imgItem">
            </div>

            <div class="col-lg-8 col-5">
                <h3 id="namaItem">NAMA BARANG</h3>
                <h5 id="keteranganItem">KETERANGAN</h5>
                <h3 id="qtyItem">QUANTITY</h3>
            </div>
        ...
        <button id="kembalikanBarang" class="btn btn-dark my-4 px-5" type="button" style="border-radius:20pt">AJUKAN PENGEMBALIAN</button>
    </div>
</body>

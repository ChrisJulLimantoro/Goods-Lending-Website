...
<body>
    <!-- <div class="banner-img">
        <img src="assets/gedungQ2.jpg" class="img-fluid" alt="">
        <p>Halo</p>
    </div> -->
    <!-- Navbar -->
    <div class="container-fluid bg-warning text-white header sticky-top">
        <div class="row px-lg-4" style="margin: 0">
            <nav class="navbar navbar-dark navbar-expand-lg">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <div class="col-2 d-flex justify-content-center align-items-right">
